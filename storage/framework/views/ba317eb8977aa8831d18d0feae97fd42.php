        ...
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('admin.mahasiswa.update', $mahasiswa)); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $mahasiswa->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', $mahasiswa->email)); ?>" required
                        class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="institution" value="<?php echo e(old('institution', $mahasiswa->institution)); ?>"
                        class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" id="start_date" name="start_date" value="<?php echo e(old('start_date', $mahasiswa->start_date ? \Carbon\Carbon::parse($mahasiswa->start_date)->format('Y-m-d') : '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" id="end_date" name="end_date" value="<?php echo e(old('end_date', $mahasiswa->end_date ? \Carbon\Carbon::parse($mahasiswa->end_date)->format('Y-m-d') : '')); ?>"
                            class="datepicker w-full rounded border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/admin/mahasiswa/edit.blade.php ENDPATH**/ ?>