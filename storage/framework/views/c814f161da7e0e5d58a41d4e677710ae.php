...
<div class="bg-white rounded-lg shadow border border-gray-200 p-6">
    ...
    <form method="POST"
          action="<?php echo e(route('admin.reports.update', $user)); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="number" name="attendance_score" min="0" max="20"
                       value="<?php echo e(old('attendance_score', $latestAssessment->attendance_score)); ?>"
            ...
            <div>
                ...
                <input type="number" name="discipline_score" min="0" max="20"
                       value="<?php echo e(old('discipline_score', $latestAssessment->discipline_score)); ?>"
                       class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                       required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="performance_score" min="0" max="20"
                       value="<?php echo e(old('performance_score', $latestAssessment->performance_score)); ?>"
                       class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                       required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="initiative_score" min="0" max="20"
                       value="<?php echo e(old('initiative_score', $latestAssessment->initiative_score)); ?>"
                       class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                       required>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="cooperation_score" min="0" max="20"
                   value="<?php echo e(old('cooperation_score', $latestAssessment->cooperation_score)); ?>"
                   class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                   required>
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea name="strengths" rows="3"
                class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"><?php echo e(old('strengths', $latestAssessment->strengths)); ?></textarea>
        </div>

        <div class="mb-4">
            <label class="block text-sm font-semibold mb-1">Kelemahan</label>
            <textarea name="weaknesses" rows="3"
                class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"><?php echo e(old('weaknesses', $latestAssessment->weaknesses)); ?></textarea>
        </div>

        <div class="mb-6">
            <label class="block text-sm font-semibold mb-1">Rekomendasi</label>
            <textarea name="recommendations" rows="3"
                class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"><?php echo e(old('recommendations', $latestAssessment->recommendations)); ?></textarea>
        </div>
...
<script>
<?php if(session('alert') === 'assessment_updated'): ?>
    Swal.fire({
        icon: 'success',
        title: 'Berhasil',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/admin/reports/edit.blade.php ENDPATH**/ ?>