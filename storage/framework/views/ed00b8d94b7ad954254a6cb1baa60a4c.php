        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody class="divide-y">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <span class="inline-flex items-center rounded bg-blue-100 px-2 py-1 text-xs font-semibold text-blue-700">
                    ...
                    <td class="px-4 py-3 text-center space-x-1">
                        ...
                        <form action="<?php echo e(route('admin.groups.destroy', $group)); ?>"
                              method="POST"
                              class="inline"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistem_Magang\resources\views/admin/groups/index.blade.php ENDPATH**/ ?>