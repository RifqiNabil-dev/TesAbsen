                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3">
                                <div class="flex flex-wrap gap-2">
                                    <a href="<?php echo e(route('mahasiswa.logbooks.show', $logbook)); ?>"
                                    ...
                                    <?php if($logbook->isPending()): ?>
                                        <a href="<?php echo e(route('mahasiswa.logbooks.edit', $logbook)); ?>"
                                           class="bg-yellow-500 hover:bg-yellow-600 text-white
                                                  px-2 py-1 rounded text-xs flex items-center">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <form action="<?php echo e(route('mahasiswa.logbooks.destroy', $logbook)); ?>"
                                              method="POST"
