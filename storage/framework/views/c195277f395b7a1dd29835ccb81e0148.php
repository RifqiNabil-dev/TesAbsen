            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $mahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="border-t hover:bg-gray-50" x-show="filterRow($el)" data-name="<?php echo e(strtolower($mhs->name)); ?>"
                            data-email="<?php echo e(strtolower($mhs->email)); ?>"
                            data-institution="<?php echo e(strtolower($mhs->institution ?? '')); ?>" data-start="<?php echo e($mhs->start_date); ?>"
                            data-end="<?php echo e($mhs->end_date); ?>">
                            <td class="px-4 py-3 font-medium"><?php echo e($mhs->name); ?></td>
                            <td class="px-4 py-3"><?php echo e($mhs->email); ?></td>
                            <td class="px-4 py-3"><?php echo e($mhs->nim ?? '-'); ?></td>
                            <td class="px-4 py-3"><?php echo e($mhs->institution ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <?php if($start && $end): ?>
                            ...
                            <td class="px-4 py-3 text-center space-x-1">
                                ...
                                <form action="<?php echo e(route('admin.mahasiswa.destroy', $mhs)); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\intan\Downloads\PKL\TesAbsen\resources\views/admin/mahasiswa/index.blade.php ENDPATH**/ ?>