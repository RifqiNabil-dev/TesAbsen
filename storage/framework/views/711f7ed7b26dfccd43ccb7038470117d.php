...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow border border-gray-200">
    ...
    <div class="border-b px-6 py-4">
        <h2 class="text-lg font-bold text-gray-800">Tambah Mahasiswa</h2>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistem_Magang\resources\views/admin/mahasiswa/create.blade.php ENDPATH**/ ?>