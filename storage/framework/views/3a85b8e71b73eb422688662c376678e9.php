...
<div class="bg-white rounded-lg shadow border border-gray-200 mb-6">
    ...
    <div class="border-b px-6 py-4">
        <h5 class="text-lg font-semibold text-gray-800">Data Mahasiswa</h5>
    </div>
        ...
        <form method="POST" action="<?php echo e(route('admin.reports.assessment', $user)); ?>">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="cooperation_score" min="0" max="20"
                    value="<?php echo e(old('cooperation_score', 0)); ?>"
                    class="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                    required>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistem_Magang\resources\views/admin/reports/show.blade.php ENDPATH**/ ?>