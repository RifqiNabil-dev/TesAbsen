                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-blue-50 text-blue-800 uppercase tracking-wider font-semibold">
                        <tr>
                            ...
                            <th class="px-6 py-4">Jam Magang</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/mahasiswa/schedules/index.blade.php ENDPATH**/ ?>