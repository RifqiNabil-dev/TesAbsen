        ...
        <form method="POST" action="<?php echo e(route('mahasiswa.logbooks.store')); ?>">
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       id="date"
                       name="date"
                       value="<?php echo e(old('date', today()->format('Y-m-d'))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/mahasiswa/logbooks/create.blade.php ENDPATH**/ ?>