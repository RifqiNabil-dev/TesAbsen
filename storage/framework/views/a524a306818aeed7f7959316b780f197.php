                    ...
                    <ul class="hidden md:flex gap-8 text-sm font-medium text-gray-600">
                        <?php if(auth()->user()->isAdmin()): ?>
                            ...
                            <li><a href="<?php echo e(route('admin.users.index')); ?>"
                                    class="hover:text-blue-600 transition <?php echo e(request()->routeIs('admin.users.index') ? 'text-blue-600' : ''); ?>">Users</a>
                            </li>
                        <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/layouts/app.blade.php ENDPATH**/ ?>