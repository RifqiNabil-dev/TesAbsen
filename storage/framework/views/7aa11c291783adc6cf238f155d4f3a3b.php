...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-3xl mx-auto bg-white border rounded-lg shadow">
        <div class="px-6 py-4 border-b">
            <h5 class="text-lg font-semibold">Edit Logbook</h5>
        </div>
        ...
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('mahasiswa.logbooks.update', $logbook)); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="date" name="date" value="<?php echo e(old('date', $logbook->date->format('Y-m-d'))); ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="activity" name="activity" value="<?php echo e(old('activity', $logbook->activity)); ?>"
                        required class="w-full rounded-lg border border-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-200
                                  px-3 py-2">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="5" required class="w-full rounded-lg border border-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-200
                                     px-3 py-2"><?php echo e(old('description', $logbook->description)); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Si-Magang\resources\views/mahasiswa/logbooks/edit.blade.php ENDPATH**/ ?>