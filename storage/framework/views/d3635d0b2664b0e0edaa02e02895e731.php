        ...
        <div class="bg-cyan-500 text-white rounded-lg shadow">
            <div class="p-4 sm:p-5">
                ...
                <h4 class="text-lg sm:text-xl font-semibold">
                    <?php echo e($todaySchedule ? $todaySchedule->locations->pluck('name')->implode(', ') : '-'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\intan\Downloads\PKL\TesAbsen\resources\views/mahasiswa/dashboard.blade.php ENDPATH**/ ?>