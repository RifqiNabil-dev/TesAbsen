    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('mahasiswa.logbooks.store')); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control datepicker" id="date" name="date" value="<?php echo e(old('date', today()->format('Y-m-d'))); ?>" placeholder="Pilih tanggal" required>
            </div>

            <div class="mb-3">
                <label for="activity" class="form-label">Aktivitas <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="activity" name="activity" value="<?php echo e(old('activity')); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistem_Magang\resources\views/mahasiswa/logbooks/create.blade.php ENDPATH**/ ?>