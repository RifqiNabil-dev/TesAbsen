        ...
        <div class="p-6">
            <form method="POST" action="{{ route('admin.locations.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full rounded border border-gray-300 px-3 py-2 text-sm
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="radius" id="radius" value="{{ old('radius', 100) }}" min="10" step="1"
