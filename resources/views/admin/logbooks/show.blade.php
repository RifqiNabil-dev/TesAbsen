...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        ...
        <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="admin_notes" name="admin_notes" rows="3"
                            class="w-full rounded border border-gray-300 px-3 py-2 text-sm
                                                   focus:ring focus:ring-blue-200 focus:border-blue-500">{{ old('admin_notes') }}</textarea>
                    </div>
            ...
            <!-- BACK BUTTON -->
            <a href="{{ route('admin.logbooks.index') }}" class="inline-block rounded bg-gray-500 px-4 py-2 text-sm
