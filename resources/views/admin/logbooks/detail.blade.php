...
@section('title', 'Detail Logbook - ' . $selectedUser->name)
...
@section('content')
    <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
            <a href="{{ route('admin.logbooks.index') }}" class="hover:text-blue-600">Logbook</a>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
            <h2 class="text-2xl font-bold text-gray-800">
                Riwayat Logbook: <span class="text-blue-600">{{ $selectedUser->name }}</span>
            </h2>
            <a href="{{ route('admin.logbooks.index') }}" class="text-gray-600 hover:text-gray-900 flex items-center gap-2 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 p-4">
            <form method="GET" action="{{ route('admin.logbooks.index') }}" class="flex flex-wrap items-center gap-4">
