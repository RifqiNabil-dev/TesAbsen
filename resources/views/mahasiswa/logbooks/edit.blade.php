        ...
        <div class="p-6">
            <form method="POST" action="{{ route('mahasiswa.logbooks.update', $logbook) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="date" name="date" value="{{ old('date', $logbook->date->format('Y-m-d')) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="activity" name="activity" value="{{ old('activity', $logbook->activity) }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="5" required class="w-full rounded-lg border border-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-200
                                     px-3 py-2">{{ old('description', $logbook->description) }}</textarea>
                </div>
